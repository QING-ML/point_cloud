...
def main():
    # ply目标文件产生路径
    ply_data_dir = '/home/zqq/C++ Training/point_cloud/hw1/pythonproject/ModelNet40_2/ply_data_points'
    # off文件所在路径
    off_data_dir = '/home/zqq/C++ Training/point_cloud/hw1/pythonproject/ModelNet40_2/off_data'
